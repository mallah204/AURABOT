...
import { EXTERNAL_API_KEY, EXTERNAL_API_URL } from '@main/config';
import { ICommand, IHandleParams, IRunParams, IEventRunParams } from '@types';
...
const command: ICommand = {
  ...
  run: async (params: IRunParams | IEventRunParams) => {
    const { api, event, args, reply } = params as IRunParams;
    try {
      // Parse arguments
